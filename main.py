...
import tensorflow
app = Flask(__name__)
model = pickle.load(open('random_forest_regression_model_y_3.pkl', 'rb'))
...
def predict():
    ...
    if request.method == 'POST':
        ...
        prediction=model.predict([[bedrooms, bathrooms, sqft_living, sqft_lot, floors, waterfront, view, condition, year_to_process, zipcode]])
